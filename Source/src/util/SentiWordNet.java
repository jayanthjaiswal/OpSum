...
/**
* Sentiment wordnet implementation
* 
...
public class SentiWordNet {
	...
	/**
	* Constructs senti wordnet objects
	* Sentiment scores of words are loaded from .csv file
	*/
	...
	/**
	* Extracts senti score for given word and tag
	* @param String word 
	* @param String pos - Part of speech tag for the word
	...
	*/	
	...
	public static Double PolSentiScore(String str) {
		try{
			if( sentiwordnet == null){
				sentiwordnet = new SentiWordNet();
			}
	...
	public static Double NegSentiScore(String str) {
		try{
			if( sentiwordnet == null){
				sentiwordnet = new SentiWordNet();
			}
	...
	public static Double PosSentiScore(String str) {
		try{
			if( sentiwordnet == null){
				sentiwordnet = new SentiWordNet();
			}
